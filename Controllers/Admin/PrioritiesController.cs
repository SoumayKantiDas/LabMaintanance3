...
namespace LabMaintanance3.Controllers.Admin
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityId,priority1")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityId,priority1")] Priority priority)
        {
            if (ModelState.IsValid)
            {
